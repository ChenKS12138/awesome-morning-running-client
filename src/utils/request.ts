...
function createReqeust({ baseUrl }: ICreateRequest): IRequest {
...
export const request = createReqeust({
  baseUrl: REQUEST_BASE_URL,
});

export const oauthRequest = createReqeust({
  baseUrl: REQUEST_OAUTH_URL,
});
